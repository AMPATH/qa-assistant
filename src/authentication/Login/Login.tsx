    ...
    <img src = {Logo} className = "h-10 mx-auto mb-10"/>
        <form>
            ...
            <input autoComplete="off" name = "username" className="shadow  border rounded p-4 " type="text" placeholder="Username" required />
                ...
                <button onClick={()=>{window.location.href="/home"}} className= "bg-blue-500 hover:bg-blue-700  w-[35%] text-white font-bold py-4 px-4 rounded" type="button"> Log In </button>
            </div>
        </form>
    </div> 
</section>
